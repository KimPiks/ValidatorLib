...
namespace ValidatorLib.Extensions
{
    ...
    internal static class StringExtension
    {
        ...
        /// <summary>
        /// Compiled regex to validate email addresses.
        /// </summary>
        ...
        internal static bool IsPhoneNumber(this string str) =>
            PhoneNumberRegex.IsMatch(str);

        /// <summary>
        /// Compiled regex to validate phone numbers.
        /// </summary>
        private static readonly Regex PhoneNumberRegex = new Regex (@"^[+]*[(]{0,1}[0-9]{1,4}[)]{0,1}[-\s\./0-9]*$", RegexOptions.Compiled);
